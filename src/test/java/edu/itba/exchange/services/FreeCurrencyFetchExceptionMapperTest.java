...
class FreeCurrencyFetchExceptionMapperTest {
    ...
    @Test
    void shouldTranslate422WithNullErrors() {
        // Given
        final var mapper = new FreeCurrencyFetchExceptionMapper(json);
        final var body = "{\"message\":\"error\"}";
        final var fe = new FetchException(422, body);
    ...
    @Test
    void shouldTranslate422WithNullResponse() {
        // Given
        final var mapper = new FreeCurrencyFetchExceptionMapper(json);
        final var body = "invalid json";
        final var fe = new FetchException(422, body);

        when(json.parse(eq(body), any())).thenReturn(null);
